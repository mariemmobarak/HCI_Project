...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderQuestion() {
    ...
    document.getElementById(
      "question-text"
    ).textContent = `${question.num1} × ${question.num2} = ?`;
    answerInput.value = "";
    answerInput.focus();
  ...
  function resetQuiz() {
    ...
    document
      .getElementById("grade-display")
      .classList.remove("grade-excellent", "grade-good", "grade-needs-work");
